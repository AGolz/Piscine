...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/22 19:10:20 by elmaksim          #+#    #+#             */
/*   Updated: 2023/11/22 21:57:14 by elmaksim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//    if (result == 8) {
//        printf("Test 1 Passed: ft_recursive_power(2, 3) = %d\n", result);
//    } else {
//        printf("Test 1 Failed: Expected 8, Got %d\n", result);
//    }
//    // Test case 2: Test the power of 0 (e.g., 0^5)
//    result = ft_recursive_power(0, 5);
//    if (result == 0) {
//        printf("Test 2 Passed: ft_recursive_power(0, 5) = %d\n", result);
//    } else {
//        printf("Test 2 Failed: Expected 0, Got %d\n", result);
//    }
//    // Test case 3: Test the power with an exponent of 1 (e.g., 4^1)
//    result = ft_recursive_power(4, 1);
//    if (result == 4) {
//        printf("Test 3 Passed: ft_recursive_power(4, 1) = %d\n", result);
//    } else {
...
//    if (result == 0) {
//        printf("Test 4 Passed: ft_recursive_power(3, -2) = %d\n", result);
//    } else {
...
//    if (result == 1) {
//        printf("Test 5 Passed: ft_recursive_power(0, 0) = %d\n", result);
//    } else {
